...
func (filter *collisionFilter) ShouldCollide(fixtureA *box2d.B2Fixture, fixtureB *box2d.B2Fixture) bool {
	...
	// TODO: SOCCER: AVOID COLLISION WITH BALL WHEN CARRYING BALL
	// OWNER => HOLDER
...
func newCollisionFilter(game *SoccerGame) *collisionFilter {
...
func newCollisionListener(game *SoccerGame) *collisionListener {
	return &collisionListener{
		game:            game,
		collisionbuffer: make([]box2d.B2ContactInterface, 0),
	}
}
